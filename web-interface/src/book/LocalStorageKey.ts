export class LocalStorageKey {
    public static readonly TEMPERATURE_UNIT_KEY = "temperature_unit";
    public static readonly INSERTED_KEY = "inserted_key";
    public static readonly CO2_KEY = "co2_key";
    public static readonly TVOC_KEY = "tvoc_key";
    public static readonly PRESSURE_KEY = "pressure_key";
    ...
    public static readonly PRESSURE_STATUS_KEY = "pressure_status_key";
